      ...
      <form method="POST" action="../backend/enrollmentAuth.php">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="enrollmentNo" class="form-control" value="<?php echo $row['enrollmentNo']; ?>" required>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="../backend/enrollmentAuth.php">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
          <button type="submit" name="deleteEnrollment" class="btn btn-danger">Delete</button>
        </div>
      </form>
    </div>
  </div>
